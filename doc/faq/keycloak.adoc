...
The simplest solution is to configure the OAuth Sheriff library to make the `sub` claim optional for Keycloak issuers:
...
- https://datatracker.ietf.org/doc/html/rfc7540#section-8.1.2[RFC 7540: HTTP/2 Header Compression]
- https://datatracker.ietf.org/doc/html/rfc7230#section-3.2[RFC 7230: HTTP/1.1 Message Syntax]
