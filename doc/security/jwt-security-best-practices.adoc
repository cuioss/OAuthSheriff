...
1. **Always validate token signatures**
   ...
   * *Implementation*: link:../../oauth-sheriff-core/src/main/java/de/cuioss/sheriff/oauth/core/TokenValidator.java[TokenValidator.java] enforces signature validation pipeline
...
2. **Enforce strict audience validation**
   ...
   * *Implementation*: link:../../oauth-sheriff-core/src/main/java/de/cuioss/sheriff/oauth/core/pipeline/validator/TokenClaimValidator.java[TokenClaimValidator.java:233-249] validates audience claims
...
3. **Enforce issuer validation**
   ...
   * *Implementation*: link:../../oauth-sheriff-core/src/main/java/de/cuioss/sheriff/oauth/core/IssuerConfig.java[IssuerConfig.java] enforces issuer validation
...
4. **Implement expiration and issuance time validation**
   ...
   * *Implementation*: link:../../oauth-sheriff-core/src/main/java/de/cuioss/sheriff/oauth/core/pipeline/validator/TokenClaimValidator.java[TokenClaimValidator.java:172-183] validates temporal claims
...
1. **Use strong, asymmetric algorithms**
   ...
   * *Implementation*: link:../../oauth-sheriff-core/src/main/java/de/cuioss/sheriff/oauth/core/security/SignatureAlgorithmPreferences.java[SignatureAlgorithmPreferences.java] automatically rejects HMAC algorithms
...
2. **Explicitly specify allowed algorithms**
   ...
   * *Implementation*: link:../../oauth-sheriff-core/src/main/java/de/cuioss/sheriff/oauth/core/security/SignatureAlgorithmPreferences.java[SignatureAlgorithmPreferences.java:53] explicitly rejects "none" and HMAC algorithms
...
3. **Enforce consistent algorithm usage**
   ...
   * *Implementation*: link:../../oauth-sheriff-core/src/main/java/de/cuioss/sheriff/oauth/core/pipeline/validator/TokenSignatureValidator.java[TokenSignatureValidator.java:250-262] enforces algorithm-key compatibility
...
This section provides guidance on implementing effective security logging. For information on how the library implements security event logging, see xref:security-specifications.adoc#security-events-monitoring[Security Events Monitoring] in the Security Specifications document.
...
* https://datatracker.ietf.org/doc/html/rfc7519 - JSON Web Token (JWT) RFC
* https://datatracker.ietf.org/doc/html/rfc7515 - JSON Web Signature (JWS) RFC
* https://datatracker.ietf.org/doc/html/rfc7518 - JSON Web Algorithms (JWA) RFC
