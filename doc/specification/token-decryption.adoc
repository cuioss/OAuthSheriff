...
== Overview
_See Requirement xref:../Requirements.adoc#OAUTH-SHERIFF-1.4[OAUTH-SHERIFF-1.4: Token Decryption (Optional - Future Version)]_
...
The `DecodedJwt` record needs to be extended to support JWE structure:
