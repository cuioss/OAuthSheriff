...
_See detailed analysis: xref:../benchmarking/doc/Analysis-01.2026-Micro.adoc#_error_handling_performance[Error Handling Performance]_
...
_See analysis: xref:../benchmarking/doc/Analysis-01.2026-Integration.adoc#_connection_count_investigation_results[Connection Scaling Analysis]_
