...
[source,bash]
----
# Serve results locally with web UI (note: serve-reports.sh serves benchmark-library results)
cd benchmarking/scripts
./serve-reports.sh library  # Opens http://localhost:8080 (serves benchmark-library, not benchmark-core)
