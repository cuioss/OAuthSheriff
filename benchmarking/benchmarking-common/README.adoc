...
* **PrometheusMetricsManager** - Prometheus-specific metrics implementation
...
PrometheusMetricsManager manager = new PrometheusMetricsManager("http://localhost:9090");
// Use manager to check Prometheus availability and collect metrics
----
