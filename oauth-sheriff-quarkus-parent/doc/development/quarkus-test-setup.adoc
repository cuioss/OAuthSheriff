...
`@EnableAutoWeld` automatically discovers and registers beans based on CDI discovery rules, simplifying test setup compared to explicit `WeldInitiator` configuration.
