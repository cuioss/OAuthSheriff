...
This document defines the comprehensive native image configuration for the OAuth Sheriff Quarkus extension, including reflection settings, resource inclusion, and build parameters for GraalVM compilation.
