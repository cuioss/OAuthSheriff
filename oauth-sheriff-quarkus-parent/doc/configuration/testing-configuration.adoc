...
This document defines testing configuration patterns and utilities for applications using the OAuth Sheriff Quarkus extension. It provides test profile setup, token generation utilities, and validation testing approaches.
