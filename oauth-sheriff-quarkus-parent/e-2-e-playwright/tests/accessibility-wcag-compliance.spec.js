...
import { accessibilityTest as test, expect } from '../fixtures/test-fixtures.js';
import { CONSTANTS } from '../utils/constants.js';

test.describe('Accessibility - WCAG 2.1 AA Compliance', () => {
  test('Full Dev-UI page WCAG compliance', async ({ page, accessibilityHelper }) => {
  ...
  test('JWT Validation Status page accessibility', async ({ page, accessibilityHelper }) => {
  ...
  test('JWKS Endpoints page accessibility', async ({ page, accessibilityHelper }) => {
  ...
  test('Token Debugger page accessibility', async ({ page, accessibilityHelper }) => {
  ...
  test('Configuration page accessibility', async ({ page, accessibilityHelper }) => {
  ...
  test('Keyboard navigation works on Token Debugger', async ({ page }) => {
    ...
    expect(['button', 'textarea', 'input', 'a', 'select']).toContain(focusedTag);
  });
});
