...
const KEYCLOAK_URL = process.env.PLAYWRIGHT_KEYCLOAK_URL || 'https://localhost:1443';
...
export const CONSTANTS = {
  ...
  SELECTORS: {
    ...
    VALIDATION_STATUS_INDICATOR: '[data-testid="validation-status-indicator"]',
    ...
    JWT_DEBUGGER_VALIDATE_BUTTON: '[data-testid="jwt-debugger-validate-button"]',
    JWT_DEBUGGER_CLEAR_BUTTON: '[data-testid="jwt-debugger-clear-button"]',
    JWT_DEBUGGER_SAMPLE_BUTTON: '[data-testid="jwt-debugger-sample-button"]',
    ...
    JWT_CONFIG_HEALTH_INDICATOR: '[data-testid="jwt-config-health-indicator"]',
    JWT_CONFIG_REFRESH_BUTTON: '[data-testid="jwt-config-refresh-button"]',
    JWT_CONFIG_GENERAL_SECTION: '[data-testid="jwt-config-general-section"]',
    JWT_CONFIG_PARSER_SECTION: '[data-testid="jwt-config-parser-section"]',
    JWT_CONFIG_ISSUERS_SECTION: '[data-testid="jwt-config-issuers-section"]',
