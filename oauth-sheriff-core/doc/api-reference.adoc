...
public class ParserConfig {
    public static class Builder {
        public Builder maxTokenSize(int bytes);      // Default: 8192 (8KB)
        public Builder maxPayloadSize(int bytes);    // Default: 8192 (8KB)
        public Builder maxStringLength(int bytes);   // Default: 4096 (4KB)
        public Builder maxBufferSize(int bytes);     // Default: 131072 (128KB)
    }
}
----
...
public class AccessTokenCacheConfig {
    public static class Builder {
        public Builder maxSize(int entries);                  // Default: 1000
        public Builder evictionIntervalSeconds(long seconds); // Default: 10
    }
}
----
